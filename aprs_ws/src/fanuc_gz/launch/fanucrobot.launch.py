...
def launch_setup(context, *args, **kwargs):
    ...
    description = launch_ros.substitutions.FindPackageShare(package='fanuc_lrmate200id').find('fanuc_lrmate200id')
    ...
    gz_spawn_entity = Node(
        ...
        executable='create',
        parameters=[
            {'robot_description':  launch_ros.descriptions.ParameterValue( launch.substitutions.Command(['xacro ',os.path.join(description,'urdf/fanuc.urdf.xacro')]), value_type=str)  }],
        output='screen',
