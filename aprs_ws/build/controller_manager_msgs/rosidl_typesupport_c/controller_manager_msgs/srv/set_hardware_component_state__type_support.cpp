...
static const _SetHardwareComponentState_Event_type_support_symbol_names_t _SetHardwareComponentState_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, controller_manager_msgs, srv, SetHardwareComponentState_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, controller_manager_msgs, srv, SetHardwareComponentState_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, controller_manager_msgs, srv, SetHardwareComponentState_Event)() {
  return &::controller_manager_msgs::srv::rosidl_typesupport_c::SetHardwareComponentState_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t SetHardwareComponentState_service_type_support_handle = {
  ...
  &SetHardwareComponentState_Request_message_type_support_handle,
  &SetHardwareComponentState_Response_message_type_support_handle,
  &SetHardwareComponentState_Event_message_type_support_handle,
