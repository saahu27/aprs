...
class Metaclass_ListControllers_Event(type):
    """Metaclass of message 'ListControllers_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__list_controllers__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__list_controllers__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__list_controllers__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__list_controllers__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__list_controllers__event
...
class ListControllers_Event(metaclass=Metaclass_ListControllers_Event):
    """Message class 'ListControllers_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<controller_manager_msgs/ListControllers_Request, 1>',
        'response': 'sequence<controller_manager_msgs/ListControllers_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['controller_manager_msgs', 'srv'], 'ListControllers_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['controller_manager_msgs', 'srv'], 'ListControllers_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from controller_manager_msgs.srv import ListControllers_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ListControllers_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'ListControllers_Request'"
        self._request = value
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ListControllers_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'ListControllers_Response'"
...
class Metaclass_ListControllers(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _list_controllers.Metaclass_ListControllers_Event._TYPE_SUPPORT is None:
                _list_controllers.Metaclass_ListControllers_Event.__import_type_support__()
...
class ListControllers(metaclass=Metaclass_ListControllers):
    ...
    from controller_manager_msgs.srv._list_controllers import ListControllers_Event as Event
