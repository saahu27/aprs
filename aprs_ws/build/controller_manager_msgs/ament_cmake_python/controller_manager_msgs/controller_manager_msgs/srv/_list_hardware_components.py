...
class Metaclass_ListHardwareComponents_Event(type):
    """Metaclass of message 'ListHardwareComponents_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__list_hardware_components__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__list_hardware_components__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__list_hardware_components__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__list_hardware_components__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__list_hardware_components__event
...
class ListHardwareComponents_Event(metaclass=Metaclass_ListHardwareComponents_Event):
    """Message class 'ListHardwareComponents_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<controller_manager_msgs/ListHardwareComponents_Request, 1>',
        'response': 'sequence<controller_manager_msgs/ListHardwareComponents_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['controller_manager_msgs', 'srv'], 'ListHardwareComponents_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['controller_manager_msgs', 'srv'], 'ListHardwareComponents_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from controller_manager_msgs.srv import ListHardwareComponents_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ListHardwareComponents_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'ListHardwareComponents_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from controller_manager_msgs.srv import ListHardwareComponents_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ListHardwareComponents_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'ListHardwareComponents_Response'"
...
class Metaclass_ListHardwareComponents(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _list_hardware_components.Metaclass_ListHardwareComponents_Event._TYPE_SUPPORT is None:
                _list_hardware_components.Metaclass_ListHardwareComponents_Event.__import_type_support__()
...
class ListHardwareComponents(metaclass=Metaclass_ListHardwareComponents):
    ...
    from controller_manager_msgs.srv._list_hardware_components import ListHardwareComponents_Event as Event
