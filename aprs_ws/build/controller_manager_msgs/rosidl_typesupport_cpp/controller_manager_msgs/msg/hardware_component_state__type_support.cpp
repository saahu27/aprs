...
static const _HardwareComponentState_type_support_symbol_names_t _HardwareComponentState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, controller_manager_msgs, msg, HardwareComponentState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, controller_manager_msgs, msg, HardwareComponentState)),
  }
};
...
{
  return &::controller_manager_msgs::msg::rosidl_typesupport_cpp::HardwareComponentState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, controller_manager_msgs, msg, HardwareComponentState)() {
  return get_message_type_support_handle<controller_manager_msgs::msg::HardwareComponentState>();
}
