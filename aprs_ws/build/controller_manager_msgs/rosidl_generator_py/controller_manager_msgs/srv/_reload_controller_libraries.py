...
class Metaclass_ReloadControllerLibraries_Event(type):
    """Metaclass of message 'ReloadControllerLibraries_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__reload_controller_libraries__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__reload_controller_libraries__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__reload_controller_libraries__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__reload_controller_libraries__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__reload_controller_libraries__event
...
class ReloadControllerLibraries_Event(metaclass=Metaclass_ReloadControllerLibraries_Event):
    """Message class 'ReloadControllerLibraries_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<controller_manager_msgs/ReloadControllerLibraries_Request, 1>',
        'response': 'sequence<controller_manager_msgs/ReloadControllerLibraries_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['controller_manager_msgs', 'srv'], 'ReloadControllerLibraries_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['controller_manager_msgs', 'srv'], 'ReloadControllerLibraries_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from controller_manager_msgs.srv import ReloadControllerLibraries_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, ReloadControllerLibraries_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'ReloadControllerLibraries_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from controller_manager_msgs.srv import ReloadControllerLibraries_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ReloadControllerLibraries_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'ReloadControllerLibraries_Response'"
...
class Metaclass_ReloadControllerLibraries(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _reload_controller_libraries.Metaclass_ReloadControllerLibraries_Event._TYPE_SUPPORT is None:
                _reload_controller_libraries.Metaclass_ReloadControllerLibraries_Event.__import_type_support__()
...
class ReloadControllerLibraries(metaclass=Metaclass_ReloadControllerLibraries):
    ...
    from controller_manager_msgs.srv._reload_controller_libraries import ReloadControllerLibraries_Event as Event
