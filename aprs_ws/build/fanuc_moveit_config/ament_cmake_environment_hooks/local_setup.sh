...
: ${AMENT_CURRENT_PREFIX:="/workspaces/aprs/aprs_ws/install/fanuc_moveit_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/fanuc_moveit_config/environment/pythonpath.sh"
