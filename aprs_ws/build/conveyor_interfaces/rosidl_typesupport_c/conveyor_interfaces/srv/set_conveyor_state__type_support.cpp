...
static const _SetConveyorState_Request_type_support_symbol_names_t _SetConveyorState_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, conveyor_interfaces, srv, SetConveyorState_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, conveyor_interfaces, srv, SetConveyorState_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, conveyor_interfaces, srv, SetConveyorState_Request)() {
  return &::conveyor_interfaces::srv::rosidl_typesupport_c::SetConveyorState_Request_message_type_support_handle;
}
...
static const _SetConveyorState_Response_type_support_symbol_names_t _SetConveyorState_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, conveyor_interfaces, srv, SetConveyorState_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, conveyor_interfaces, srv, SetConveyorState_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, conveyor_interfaces, srv, SetConveyorState_Response)() {
  return &::conveyor_interfaces::srv::rosidl_typesupport_c::SetConveyorState_Response_message_type_support_handle;
}
...
static const _SetConveyorState_type_support_symbol_names_t _SetConveyorState_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, conveyor_interfaces, srv, SetConveyorState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, conveyor_interfaces, srv, SetConveyorState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, conveyor_interfaces, srv, SetConveyorState)() {
  return &::conveyor_interfaces::srv::rosidl_typesupport_c::SetConveyorState_service_type_support_handle;
}
