...
class Metaclass_IsProgramSaved_Event(type):
    """Metaclass of message 'IsProgramSaved_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__is_program_saved__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__is_program_saved__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__is_program_saved__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__is_program_saved__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__is_program_saved__event
...
class IsProgramSaved_Event(metaclass=Metaclass_IsProgramSaved_Event):
    """Message class 'IsProgramSaved_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<ur_dashboard_msgs/IsProgramSaved_Request, 1>',
        'response': 'sequence<ur_dashboard_msgs/IsProgramSaved_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ur_dashboard_msgs', 'srv'], 'IsProgramSaved_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ur_dashboard_msgs', 'srv'], 'IsProgramSaved_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from ur_dashboard_msgs.srv import IsProgramSaved_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, IsProgramSaved_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'IsProgramSaved_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from ur_dashboard_msgs.srv import IsProgramSaved_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, IsProgramSaved_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'IsProgramSaved_Response'"
...
class Metaclass_IsProgramSaved(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _is_program_saved.Metaclass_IsProgramSaved_Event._TYPE_SUPPORT is None:
                _is_program_saved.Metaclass_IsProgramSaved_Event.__import_type_support__()
...
class IsProgramSaved(metaclass=Metaclass_IsProgramSaved):
    ...
    from ur_dashboard_msgs.srv._is_program_saved import IsProgramSaved_Event as Event
