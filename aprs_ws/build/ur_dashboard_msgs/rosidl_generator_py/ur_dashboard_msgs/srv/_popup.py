...
class Metaclass_Popup_Event(type):
    """Metaclass of message 'Popup_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__popup__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__popup__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__popup__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__popup__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__popup__event
...
class Popup_Event(metaclass=Metaclass_Popup_Event):
    """Message class 'Popup_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<ur_dashboard_msgs/Popup_Request, 1>',
        'response': 'sequence<ur_dashboard_msgs/Popup_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ur_dashboard_msgs', 'srv'], 'Popup_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ur_dashboard_msgs', 'srv'], 'Popup_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from ur_dashboard_msgs.srv import Popup_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, Popup_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'Popup_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from ur_dashboard_msgs.srv import Popup_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, Popup_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'Popup_Response'"
...
class Metaclass_Popup(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _popup.Metaclass_Popup_Event._TYPE_SUPPORT is None:
                _popup.Metaclass_Popup_Event.__import_type_support__()
...
class Popup(metaclass=Metaclass_Popup):
    ...
    from ur_dashboard_msgs.srv._popup import Popup_Event as Event
