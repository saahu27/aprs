...
static const _Load_Event_type_support_symbol_names_t _Load_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ur_dashboard_msgs, srv, Load_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ur_dashboard_msgs, srv, Load_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ur_dashboard_msgs, srv, Load_Event)() {
  return &::ur_dashboard_msgs::srv::rosidl_typesupport_c::Load_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t Load_service_type_support_handle = {
  ...
  &Load_Request_message_type_support_handle,
  &Load_Response_message_type_support_handle,
  &Load_Event_message_type_support_handle,
