...
static const _GetLoadedProgram_Event_type_support_symbol_names_t _GetLoadedProgram_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ur_dashboard_msgs, srv, GetLoadedProgram_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ur_dashboard_msgs, srv, GetLoadedProgram_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ur_dashboard_msgs, srv, GetLoadedProgram_Event)() {
  return &::ur_dashboard_msgs::srv::rosidl_typesupport_c::GetLoadedProgram_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t GetLoadedProgram_service_type_support_handle = {
  ...
  &GetLoadedProgram_Request_message_type_support_handle,
  &GetLoadedProgram_Response_message_type_support_handle,
  &GetLoadedProgram_Event_message_type_support_handle,
