...
class Metaclass_QueryCalibrationState_Event(type):
    """Metaclass of message 'QueryCalibrationState_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__query_calibration_state__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__query_calibration_state__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__query_calibration_state__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__query_calibration_state__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__query_calibration_state__event
...
class QueryCalibrationState_Event(metaclass=Metaclass_QueryCalibrationState_Event):
    """Message class 'QueryCalibrationState_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<control_msgs/QueryCalibrationState_Request, 1>',
        'response': 'sequence<control_msgs/QueryCalibrationState_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['control_msgs', 'srv'], 'QueryCalibrationState_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['control_msgs', 'srv'], 'QueryCalibrationState_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from control_msgs.srv import QueryCalibrationState_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, QueryCalibrationState_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'QueryCalibrationState_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from control_msgs.srv import QueryCalibrationState_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, QueryCalibrationState_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'QueryCalibrationState_Response'"
...
class Metaclass_QueryCalibrationState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _query_calibration_state.Metaclass_QueryCalibrationState_Event._TYPE_SUPPORT is None:
                _query_calibration_state.Metaclass_QueryCalibrationState_Event.__import_type_support__()
...
class QueryCalibrationState(metaclass=Metaclass_QueryCalibrationState):
    ...
    from control_msgs.srv._query_calibration_state import QueryCalibrationState_Event as Event
