...
static const _DeviceInfo_Event_type_support_symbol_names_t _DeviceInfo_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, realsense2_camera_msgs, srv, DeviceInfo_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, realsense2_camera_msgs, srv, DeviceInfo_Event)),
  }
};
...
{
  return &::realsense2_camera_msgs::srv::rosidl_typesupport_cpp::DeviceInfo_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, realsense2_camera_msgs, srv, DeviceInfo_Event)() {
  return get_message_type_support_handle<realsense2_camera_msgs::srv::DeviceInfo_Event>();
}
...
static const rosidl_service_type_support_t DeviceInfo_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<realsense2_camera_msgs::srv::DeviceInfo_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<realsense2_camera_msgs::srv::DeviceInfo_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<realsense2_camera_msgs::srv::DeviceInfo_Event>(),
