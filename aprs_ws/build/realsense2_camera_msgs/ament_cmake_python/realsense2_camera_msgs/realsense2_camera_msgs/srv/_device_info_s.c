...
ROSIDL_GENERATOR_C_EXPORT
bool realsense2_camera_msgs__srv__device_info__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("realsense2_camera_msgs.srv._device_info.DeviceInfo_Event", full_classname_dest, 56) == 0);
  }
  realsense2_camera_msgs__srv__DeviceInfo_Event * ros_message = _ros_message;
  {  // info
  ...
  {  // request
    ...
    if (!realsense2_camera_msgs__srv__DeviceInfo_Request__Sequence__init(&(ros_message->request), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create realsense2_camera_msgs__srv__DeviceInfo_Request__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    realsense2_camera_msgs__srv__DeviceInfo_Request * dest = ros_message->request.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!realsense2_camera_msgs__srv__device_info__request__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // response
    ...
    if (!realsense2_camera_msgs__srv__DeviceInfo_Response__Sequence__init(&(ros_message->response), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create realsense2_camera_msgs__srv__DeviceInfo_Response__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    realsense2_camera_msgs__srv__DeviceInfo_Response * dest = ros_message->response.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!realsense2_camera_msgs__srv__device_info__response__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * realsense2_camera_msgs__srv__device_info__event__convert_to_py(void * raw_ros_message)
{
  ...
  {  // request
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = realsense2_camera_msgs__srv__device_info__request__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // response
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = realsense2_camera_msgs__srv__device_info__response__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
