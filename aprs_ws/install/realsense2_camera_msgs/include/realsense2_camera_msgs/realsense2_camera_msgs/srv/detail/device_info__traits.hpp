...
[[deprecated("use realsense2_camera_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const realsense2_camera_msgs::srv::DeviceInfo_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  realsense2_camera_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use realsense2_camera_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const realsense2_camera_msgs::srv::DeviceInfo_Event & msg)
{
  return realsense2_camera_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<realsense2_camera_msgs::srv::DeviceInfo_Event>()
{
  return "realsense2_camera_msgs::srv::DeviceInfo_Event";
}

template<>
inline const char * name<realsense2_camera_msgs::srv::DeviceInfo_Event>()
{
  return "realsense2_camera_msgs/srv/DeviceInfo_Event";
}

template<>
struct has_fixed_size<realsense2_camera_msgs::srv::DeviceInfo_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<realsense2_camera_msgs::srv::DeviceInfo_Event>
  : std::integral_constant<bool, has_bounded_size<realsense2_camera_msgs::srv::DeviceInfo_Request>::value && has_bounded_size<realsense2_camera_msgs::srv::DeviceInfo_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<realsense2_camera_msgs::srv::DeviceInfo_Event>
  : std::true_type {};
