...
enum
{
  realsense2_camera_msgs__srv__DeviceInfo_Event__request__MAX_SIZE = 1
};
// response
enum
{
  realsense2_camera_msgs__srv__DeviceInfo_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/DeviceInfo in the package realsense2_camera_msgs.
typedef struct realsense2_camera_msgs__srv__DeviceInfo_Event
{
  service_msgs__msg__ServiceEventInfo info;
  realsense2_camera_msgs__srv__DeviceInfo_Request__Sequence request;
  realsense2_camera_msgs__srv__DeviceInfo_Response__Sequence response;
} realsense2_camera_msgs__srv__DeviceInfo_Event;

// Struct for a sequence of realsense2_camera_msgs__srv__DeviceInfo_Event.
typedef struct realsense2_camera_msgs__srv__DeviceInfo_Event__Sequence
{
