...
: ${AMENT_CURRENT_PREFIX:="/workspaces/aprs/aprs_ws/install/fanuc_gz"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/fanuc_gz/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/fanuc_gz/environment/path.sh"
