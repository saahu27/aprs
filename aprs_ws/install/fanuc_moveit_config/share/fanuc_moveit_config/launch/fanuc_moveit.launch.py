...
def launch_setup(context, *args, **kwargs):
    ...
    ## Moveit Parameters
    robot_description_semantic = {"robot_description_semantic": load_file("fanuc_moveit_config", "srdf/fanuc.srdf")}

    robot_description_kinematics = {"robot_description_kinematics": load_yaml("fanuc_moveit_config", "config/kinematics.yaml")}
    ...
    ompl_planning_yaml = load_yaml("fanuc_moveit_config", "config/ompl_planning.yaml")

    ompl_planning_pipeline_config["move_group"].update(ompl_planning_yaml) # type: ignore
    
    moveit_controllers = {
        "moveit_simple_controller_manager": load_yaml("fanuc_moveit_config", "config/controllers.yaml"),
    ...
    joint_limits = {"robot_description_planning": load_yaml(
        "fanuc_moveit_config", "config/joint_limits.yaml"
    )}
    ...
    rviz_config_file = PathJoinSubstitution(
        [FindPackageShare("fanuc_moveit_config"), "rviz", "moveit.rviz"]
    )
