...
: ${AMENT_CURRENT_PREFIX:="/workspaces/aprs_humble/aprs_ws/install/worlds"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/worlds/environment/worlds.sh"
