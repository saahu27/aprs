...
: ${AMENT_CURRENT_PREFIX:="/workspaces/aprs/aprs_ws/install/gz_ros2_control_demos"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/gz_ros2_control_demos/environment/gz_ros2_control_demos.sh"
