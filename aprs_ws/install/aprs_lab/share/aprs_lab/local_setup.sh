...
: ${AMENT_CURRENT_PREFIX:="/workspaces/aprs/aprs_ws/install/aprs_lab"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/aprs_lab/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/aprs_lab/environment/path.sh"
