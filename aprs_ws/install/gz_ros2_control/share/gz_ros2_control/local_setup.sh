...
: ${AMENT_CURRENT_PREFIX:="/workspaces/aprs/aprs_ws/install/gz_ros2_control"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/gz_ros2_control/environment/gz_ros2_control.sh"
