...
: ${AMENT_CURRENT_PREFIX:="/workspaces/aprs_humble/aprs_ws/install/ign_ros2_control"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ign_ros2_control/environment/ign_ros2_control.sh"
