...
class Metaclass_ListControllerTypes_Event(type):
    """Metaclass of message 'ListControllerTypes_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__list_controller_types__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__list_controller_types__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__list_controller_types__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__list_controller_types__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__list_controller_types__event
...
class ListControllerTypes_Event(metaclass=Metaclass_ListControllerTypes_Event):
    """Message class 'ListControllerTypes_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<controller_manager_msgs/ListControllerTypes_Request, 1>',
        'response': 'sequence<controller_manager_msgs/ListControllerTypes_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['controller_manager_msgs', 'srv'], 'ListControllerTypes_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['controller_manager_msgs', 'srv'], 'ListControllerTypes_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from controller_manager_msgs.srv import ListControllerTypes_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ListControllerTypes_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'ListControllerTypes_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from controller_manager_msgs.srv import ListControllerTypes_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ListControllerTypes_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'ListControllerTypes_Response'"
...
class Metaclass_ListControllerTypes(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _list_controller_types.Metaclass_ListControllerTypes_Event._TYPE_SUPPORT is None:
                _list_controller_types.Metaclass_ListControllerTypes_Event.__import_type_support__()
...
class ListControllerTypes(metaclass=Metaclass_ListControllerTypes):
    ...
    from controller_manager_msgs.srv._list_controller_types import ListControllerTypes_Event as Event
