...
: ${AMENT_CURRENT_PREFIX:="/workspaces/aprs/aprs_ws/install/fanuc_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/fanuc_description/environment/fanuc_description.sh"
