...
: ${AMENT_CURRENT_PREFIX:="/workspaces/aprs_humble/aprs_ws/install/franka_gz"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/franka_gz/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/franka_gz/environment/path.sh"
