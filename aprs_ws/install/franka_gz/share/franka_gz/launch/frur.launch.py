...
def generate_launch_description():
    ...
    urdf = os.path.join(get_package_share_directory('ur_description'), "urdf", "ur.urdf.xacro")
    pkg_box_bot_description = get_package_share_directory('franka_gz')
