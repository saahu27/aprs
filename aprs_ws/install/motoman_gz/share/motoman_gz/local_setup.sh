...
: ${AMENT_CURRENT_PREFIX:="/workspaces/aprs/aprs_ws/install/motoman_gz"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/motoman_gz/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/motoman_gz/environment/path.sh"
