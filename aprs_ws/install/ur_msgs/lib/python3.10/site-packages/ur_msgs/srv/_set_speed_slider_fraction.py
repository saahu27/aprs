    ...
    def speed_slider_fraction(self, value):
        if self._check_fields:
            ...
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'speed_slider_fraction' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
...
class Metaclass_SetSpeedSliderFraction_Event(type):
    """Metaclass of message 'SetSpeedSliderFraction_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__set_speed_slider_fraction__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__set_speed_slider_fraction__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__set_speed_slider_fraction__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__set_speed_slider_fraction__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__set_speed_slider_fraction__event
...
class SetSpeedSliderFraction_Event(metaclass=Metaclass_SetSpeedSliderFraction_Event):
    """Message class 'SetSpeedSliderFraction_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<ur_msgs/SetSpeedSliderFraction_Request, 1>',
        'response': 'sequence<ur_msgs/SetSpeedSliderFraction_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ur_msgs', 'srv'], 'SetSpeedSliderFraction_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ur_msgs', 'srv'], 'SetSpeedSliderFraction_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from ur_msgs.srv import SetSpeedSliderFraction_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, SetSpeedSliderFraction_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SetSpeedSliderFraction_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from ur_msgs.srv import SetSpeedSliderFraction_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetSpeedSliderFraction_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SetSpeedSliderFraction_Response'"
...
class Metaclass_SetSpeedSliderFraction(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _set_speed_slider_fraction.Metaclass_SetSpeedSliderFraction_Event._TYPE_SUPPORT is None:
                _set_speed_slider_fraction.Metaclass_SetSpeedSliderFraction_Event.__import_type_support__()
...
class SetSpeedSliderFraction(metaclass=Metaclass_SetSpeedSliderFraction):
    ...
    from ur_msgs.srv._set_speed_slider_fraction import SetSpeedSliderFraction_Event as Event
