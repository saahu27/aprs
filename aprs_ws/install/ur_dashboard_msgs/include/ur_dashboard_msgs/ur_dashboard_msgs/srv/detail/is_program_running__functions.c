...
ur_dashboard_msgs__srv__IsProgramRunning_Event__init(ur_dashboard_msgs__srv__IsProgramRunning_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    ur_dashboard_msgs__srv__IsProgramRunning_Event__fini(msg);
    return false;
  }
  // request
  if (!ur_dashboard_msgs__srv__IsProgramRunning_Request__Sequence__init(&msg->request, 0)) {
    ur_dashboard_msgs__srv__IsProgramRunning_Event__fini(msg);
    return false;
  }
  // response
  if (!ur_dashboard_msgs__srv__IsProgramRunning_Response__Sequence__init(&msg->response, 0)) {
    ur_dashboard_msgs__srv__IsProgramRunning_Event__fini(msg);
    return false;
  }
  return true;
...
ur_dashboard_msgs__srv__IsProgramRunning_Event__fini(ur_dashboard_msgs__srv__IsProgramRunning_Event * msg)
{
  ...
  // request
  ur_dashboard_msgs__srv__IsProgramRunning_Request__Sequence__fini(&msg->request);
  // response
  ur_dashboard_msgs__srv__IsProgramRunning_Response__Sequence__fini(&msg->response);
}
...
ur_dashboard_msgs__srv__IsProgramRunning_Event__are_equal(const ur_dashboard_msgs__srv__IsProgramRunning_Event * lhs, const ur_dashboard_msgs__srv__IsProgramRunning_Event * rhs)
{
  ...
  // request
  if (!ur_dashboard_msgs__srv__IsProgramRunning_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!ur_dashboard_msgs__srv__IsProgramRunning_Response__Sequence__are_equal(
  ...
  ur_dashboard_msgs__srv__IsProgramRunning_Event * output)
{
  ...
  // request
  if (!ur_dashboard_msgs__srv__IsProgramRunning_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!ur_dashboard_msgs__srv__IsProgramRunning_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ur_dashboard_msgs__srv__IsProgramRunning_Event * msg = (ur_dashboard_msgs__srv__IsProgramRunning_Event *)allocator.allocate(sizeof(ur_dashboard_msgs__srv__IsProgramRunning_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ur_dashboard_msgs__srv__IsProgramRunning_Event));
  bool success = ur_dashboard_msgs__srv__IsProgramRunning_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ur_dashboard_msgs__srv__IsProgramRunning_Event__Sequence__init(ur_dashboard_msgs__srv__IsProgramRunning_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ur_dashboard_msgs__srv__IsProgramRunning_Event * data = NULL;

  if (size) {
    data = (ur_dashboard_msgs__srv__IsProgramRunning_Event *)allocator.zero_allocate(size, sizeof(ur_dashboard_msgs__srv__IsProgramRunning_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ur_dashboard_msgs__srv__IsProgramRunning_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ur_dashboard_msgs__srv__IsProgramRunning_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ur_dashboard_msgs__srv__IsProgramRunning_Event__Sequence__fini(ur_dashboard_msgs__srv__IsProgramRunning_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ur_dashboard_msgs__srv__IsProgramRunning_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ur_dashboard_msgs__srv__IsProgramRunning_Event__Sequence * array = (ur_dashboard_msgs__srv__IsProgramRunning_Event__Sequence *)allocator.allocate(sizeof(ur_dashboard_msgs__srv__IsProgramRunning_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ur_dashboard_msgs__srv__IsProgramRunning_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ur_dashboard_msgs__srv__IsProgramRunning_Event__Sequence__destroy(ur_dashboard_msgs__srv__IsProgramRunning_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ur_dashboard_msgs__srv__IsProgramRunning_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ur_dashboard_msgs__srv__IsProgramRunning_Event__Sequence__are_equal(const ur_dashboard_msgs__srv__IsProgramRunning_Event__Sequence * lhs, const ur_dashboard_msgs__srv__IsProgramRunning_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ur_dashboard_msgs__srv__IsProgramRunning_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ur_dashboard_msgs__srv__IsProgramRunning_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ur_dashboard_msgs__srv__IsProgramRunning_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ur_dashboard_msgs__srv__IsProgramRunning_Event * data =
      (ur_dashboard_msgs__srv__IsProgramRunning_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ur_dashboard_msgs__srv__IsProgramRunning_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ur_dashboard_msgs__srv__IsProgramRunning_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ur_dashboard_msgs__srv__IsProgramRunning_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
