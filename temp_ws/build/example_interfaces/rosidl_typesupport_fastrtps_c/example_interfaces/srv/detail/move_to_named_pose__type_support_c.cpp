...
#include "example_interfaces/srv/detail/move_to_named_pose__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // pose
#include "rosidl_runtime_c/string_functions.h"  // pose

// forward declare type support functions


using _MoveToNamedPose_Request__ros_msg_type = example_interfaces__srv__MoveToNamedPose_Request;
...
size_t get_serialized_size_example_interfaces__srv__MoveToNamedPose_Request(
  const void * untyped_ros_message,
...
static uint32_t _MoveToNamedPose_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_example_interfaces__srv__MoveToNamedPose_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_example_interfaces
size_t max_serialized_size_example_interfaces__srv__MoveToNamedPose_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = example_interfaces__srv__MoveToNamedPose_Request;
    is_plain =
      (
...
static size_t _MoveToNamedPose_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_example_interfaces__srv__MoveToNamedPose_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, example_interfaces, srv, MoveToNamedPose_Request)() {
...
using _MoveToNamedPose_Response__ros_msg_type = example_interfaces__srv__MoveToNamedPose_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_example_interfaces
size_t get_serialized_size_example_interfaces__srv__MoveToNamedPose_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MoveToNamedPose_Response__ros_msg_type * ros_message = static_cast<const _MoveToNamedPose_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_example_interfaces__srv__MoveToNamedPose_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_example_interfaces
size_t max_serialized_size_example_interfaces__srv__MoveToNamedPose_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = example_interfaces__srv__MoveToNamedPose_Response;
    is_plain =
      (
...
static size_t _MoveToNamedPose_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_example_interfaces__srv__MoveToNamedPose_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, example_interfaces, srv, MoveToNamedPose_Response)() {
...
// already included above
// #include "example_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "example_interfaces/srv/move_to_named_pose.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, example_interfaces, srv, MoveToNamedPose)() {
