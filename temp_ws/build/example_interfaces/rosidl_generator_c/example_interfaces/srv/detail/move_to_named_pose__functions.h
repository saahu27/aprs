...
#ifndef EXAMPLE_INTERFACES__SRV__DETAIL__MOVE_TO_NAMED_POSE__FUNCTIONS_H_
#define EXAMPLE_INTERFACES__SRV__DETAIL__MOVE_TO_NAMED_POSE__FUNCTIONS_H_
 ...
 * calls
 * example_interfaces__srv__MoveToNamedPose_Request__init().
...
/**
 * It calls
 * example_interfaces__srv__MoveToNamedPose_Request__fini()
 ...
 * example_interfaces__srv__MoveToNamedPose_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * example_interfaces__srv__MoveToNamedPose_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * example_interfaces__srv__MoveToNamedPose_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_example_interfaces
...
/**
 * It calls
 * example_interfaces__srv__MoveToNamedPose_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_example_interfaces
...
/**
 * It allocates the memory for the array and calls
 * example_interfaces__srv__MoveToNamedPose_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_example_interfaces
...
/**
 * It calls
 * example_interfaces__srv__MoveToNamedPose_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // EXAMPLE_INTERFACES__SRV__DETAIL__MOVE_TO_NAMED_POSE__FUNCTIONS_H_
