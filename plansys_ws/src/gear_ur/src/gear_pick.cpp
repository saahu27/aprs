#include </workspaces/aprs/plansys_ws/src/gear_ur/include/gear_pick.hpp>
...
gearpick::gearpick()
    : Node("gear_pick"),
      ...
      planning_scene_()
{
  move_to_named_pose_srv_ = this->create_service<example_interfaces::srv::MoveToNamedPose>(
      "move_to_named_pose",
      std::bind(
          &gearpick::move_to_named_pose_cb_, this,
  ...
  //     "topic", 10, std::bind(&gearpick::topic_callback, this, std::placeholders::_1));
